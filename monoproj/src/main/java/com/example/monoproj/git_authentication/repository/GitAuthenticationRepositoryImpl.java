...
@Slf4j
@Repository
public class GitAuthenticationRepositoryImpl implements GitAuthenticationRepository {
    ...
    public GitAuthenticationRepositoryImpl(
            @Value("${git.login-url") String loginUrl,
            @Value("${git.client-id}") String clientId,
            @Value("${git.redirect-uri}") String redirectUri,
            @Value("${git.token-request-uri}") String tokenRequestUri,
            @Value("${git.user-info-request-uri}") String userInfoRequestUri,
    ...
    public String getLoginLink() {
        log.info("getLoginLink() for Login");
